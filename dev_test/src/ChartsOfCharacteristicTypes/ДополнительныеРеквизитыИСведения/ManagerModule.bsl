...
Процедура УдалитьНедопустимыеСимволы(Строка)
	...
	БуквыИЦифры = "0123456789abcdefghijklmnopqrstuvwxyzабвгдеёжзийклмнопрстуфхцчшщъыьэюя_ ";
	НедопустимыеСимволы = СтрСоединить(СтрРазделить(НРег(Строка), БуквыИЦифры, Истина));
