...
Функция СформироватьСтруктуруJSONДляОтправки(Параметры)
	...
	Если Параметры.ЗапросКонтактнойИнформации = 0 
		...
		Если МассивСтрок.Количество()>=2 Тогда
			...
			Если МассивПодстрок.Количество()>=2 Тогда
				...
				Попытка
					...
					ЦентрМониторинга.ЗаписатьОперациюБизнесСтатистикиСутки("СтатистикаКлиента.ИнформацияОСистеме.СвободноНаДиске."+БукваДиска,"",РезультатЗапроса.Значение,Истина);
				Исключение
					РезультатЗапроса.Успешно = Ложь;
